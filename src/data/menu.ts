  ...
  /* ------------------------------------------------------------------ */
  {
    ...
    items: [
      ...
      },
      {
        ...
        name: "Mexicana",
        desc: {
          de: "Tomatensauce, Käse, Mais, Paprika, Tomaten, Zwiebeln, scharf",
          en: "Tomato sauce, cheese, corn, peppers, tomatoes, onions, spicy",
          tr: "Domates sosu, peynir, mısır, biber, domates, soğan, acılı",
          it: "Salsa di pomodoro, formaggio, mais, peperoni, pomodori, cipolle, piccante",
        },
        price: "12,00",
      },
      {
      ...
      },
      {
        ...
        name: "Angelo",
        desc: {
          de: "Tomatensauce, Schinken, Käse, Salami, Speck",
          en: "Tomato sauce, cheese, ham, salami, bacon",
          tr: "Domates sosu, peynir, jambon, salam, pastırma",
          it: "Salsa di pomodoro, formaggio, prosciutto, salame, pancetta",
        },
        price: "15",
      },
      {
  ...
  /* ------------------------------------------------------------------ */
  {
    ...
    items: [
      ...
      },
      {
        ...
        desc: {
          de: "Eissalat, Tomaten, Mais, Paprika, Karotten, Rucola u. Dressing",
      ...
      },
      {
        ...
        desc: {
          de: "Eissalat, Tomaten, Mais, Zwiebeln, Paprika, Karotten, Thunfisch u. Dressing",
      ...
      },
      {
        ...
        desc: {
          de: "Eissalat, Tomaten, Mais, Paprika, Zwiebeln, Feta Käse, Oliven u. Dressing",
      ...
      },
      {
        ...
        name: "Fitness Salat",
        desc: {
          de: "Eissalat, Tomaten, Mais, Paprika, Karotten, Rucola, Hühnerbruststreifen u. Dressing",
      ...
      },
      {
        ...
        desc: {
          de: "Eissalat, Tomaten, Mais, Paprika, Zwiebeln, Karotten, Crispy Chicken u. Dressing",
  ...
  /* ------------------------------------------------------------------ */
  {
    ...
    items: [
      ...
      },
      {
        ...
        name: "Langos",
        desc: {
          de: "2 Würstel in Teig gerollt mit Curry u. Sauce",
          en: "2 sausages rolled in dough with curry & sauce",
          tr: "Hamurla sarılmış 2 sosis, köri ve sos ile",
          it: "2 würstel avvolti nella pasta con curry e salsa",
        },
        price: "7,50",
      },
      {
    ...
    items: [
      {
        ...
        desc: {
          de: "Münchner Helles, 0,3 l",
          en: "Munich lager, 0.3 l",
          tr: "Münih birası, 0,3 l",
          it: "Birra chiara di Monaco, 0,3 l",
        },
        price: "3,90",
      },
      {
        ...
        desc: {
          de: "Münchner Helles, 0,5 l",
          en: "Munich lager, 0.5 l",
          tr: "Münih birası, 0,5 l",
          it: "Birra chiara di Monaco, 0,5 l",
        },
        price: "4,90",
      },
      {
