  ...
  /* ------------------------------------------------------------------ */
  {
    ...
    items: [
      ...
      },
      {
        ...
        name: "Mexicana",
        desc: {
          de: "Tomatensauce, Käse, Paprika, Zwiebeln, Schinken, scharf",
          en: "Tomato sauce, cheese, peppers, onions, ham, spicy",
          tr: "Domates sosu, peynir, biber, soğan, jambon, acılı",
          it: "Salsa di pomodoro, formaggio, peperoni, cipolle, prosciutto, piccante",
        },
        price: "12,00",
      },
      {
        ...
        name: "Mozzarella",
        desc: {
          de: "Tomatensauce, Cherrytomaten, Mozzarella",
          en: "Tomato sauce, cherry tomatoes, mozzarella",
          tr: "Domates sosu, kiraz domates, mozzarella",
          it: "Salsa di pomodoro, pomodorini, mozzarella",
        },
        price: "12,00",
      },
      {
      ...
      },
      {
        ...
        name: "Bolognese",
        desc: {
          de: "Tomatensauce, Käse, Hackfleisch",
          en: "Tomato sauce, cheese, minced meat",
          tr: "Domates sosu, peynir, kıyma",
          it: "Salsa di pomodoro, formaggio, carne macinata",
        },
        price: "14,50",
      },
      {
        ...
        name: "Pollo",
        desc: {
          de: "Tomatensauce, Käse, Hühnerbruststreifen",
          en: "Tomato sauce, cheese, chicken breast strips",
          tr: "Domates sosu, peynir, tavuk göğsü şeritleri",
          it: "Salsa di pomodoro, formaggio, strisce di petto di pollo",
        },
        price: "14,50",
      },
      {
      ...
      },
      {
        ...
        name: "Angela",
        desc: {
          de: "Tomatensauce, Käse, Schinken, Speck",
          en: "Tomato sauce, cheese, ham, bacon",
          tr: "Domates sosu, peynir, jambon, pastırma",
          it: "Salsa di pomodoro, formaggio, prosciutto, pancetta",
        },
        price: "13,50",
      },
      {
        ...
        name: "Gigant",
        desc: {
          de: "Tomatensauce, Käse, Schinken, Salami, Champignons, Zwiebeln, Paprika",
          en: "Tomato sauce, cheese, ham, salami, mushrooms, onions, peppers",
          tr: "Domates sosu, peynir, jambon, salam, mantar, soğan, biber",
          it: "Salsa di pomodoro, formaggio, prosciutto, salame, funghi, cipolle, peperoni",
        },
        price: "16,00",
      },
      {
      ...
      },
      {
        ...
        name: "Provenzale",
        desc: {
          de: "Tomatensauce, Käse, Schinken, Peperoni, Ei",
          en: "Tomato sauce, cheese, ham, pepperoni, egg",
          tr: "Domates sosu, peynir, jambon, biberiye, yumurta",
          it: "Salsa di pomodoro, formaggio, prosciutto, peperoni, uovo",
        },
        price: "13,50",
      },
      {
        ...
        name: "Sucukeria",
        desc: {
          de: "Tomatensauce, Käse, Sucuk, Oliven, Paprika, Ei",
          en: "Tomato sauce, cheese, sucuk sausage, olives, peppers, egg",
          tr: "Domates sosu, peynir, sucuk, zeytin, biber, yumurta",
          it: "Salsa di pomodoro, formaggio, sucuk, olive, peperoni, uovo",
        },
        price: "12,50",
      },
      {
        ...
        name: "Verdure",
        desc: {
          de: "Tomatensauce, Käse, gegrilltes Gemüse",
          en: "Tomato sauce, cheese, grilled vegetables",
          tr: "Domates sosu, peynir, ızgara sebze",
          it: "Salsa di pomodoro, formaggio, verdure grigliate",
        },
        price: "12,50",
      },
      {
        ...
        name: "Mafiosi",
        desc: {
          de: "Tomatensauce, Käse, scharfe Salami, Peperoni",
          en: "Tomato sauce, cheese, spicy salami, pepperoni",
          tr: "Domates sosu, peynir, acılı salam, biberiye",
          it: "Salsa di pomodoro, formaggio, salame piccante, peperoni",
        },
        price: "13,00",
      },
      {
      ...
      },
      {
        ...
        name: "Salat Calzone",
        desc: {
          de: "Tomatensauce, Käse, Salat, Dressing",
          en: "Tomato sauce, cheese, salad, dressing",
          tr: "Domates sosu, peynir, salata, sos",
          it: "Salsa di pomodoro, formaggio, insalata, condimento",
        },
        price: "13,00",
      },
      {
  ...
  /* ------------------------------------------------------------------ */
  {
    ...
    items: [
      ...
      },
      {
        ...
        name: "Ispanaklı Pide",
        desc: {
          de: "Mit Spinat u. Kräutern",
          en: "With spinach & herbs",
          tr: "Ispanaklı ve otlu",
          it: "Con spinaci e erbe aromatiche",
        },
        price: "11,50",
      },
      {
      ...
      },
      {
        ...
        desc: {
          de: "Mit Pastırma u. Käse",
          en: "With pastırma (cured beef) & cheese",
          tr: "Pastırmalı ve peynirli",
          it: "Con pastırma e formaggio",
        },
        price: "12,50",
      },
    ],
